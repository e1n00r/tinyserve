"""GGUF model loader — weights loading and tensor extraction.
...
and routes expert weights through MmapExpertStore / FusedMmapExpertStore for INT4 CPU compute.

Supports multi-shard GGUF files (e.g. Qwen3.5-122B-A10B split across 3 shards).
Also contains weight loading helpers: param navigation and expert store construction.
"""
...
from .gguf_dequant import (
    ...
    _dequant_tensor,
    dequant_tensor as _fast_dequant,
)
...
# ---------------------------------------------------------------------------
# Weight loading helpers (formerly gguf_weights.py)
# ---------------------------------------------------------------------------
